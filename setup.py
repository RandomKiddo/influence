...
md = []
with open('/Users/SchoolOfficial/Desktop/influence/README.md', 'r') as f:
    for line in f:
        md.append(str(line))
...
setup(
  ...
  download_url = 'https://github.com/RandomKiddo/influence/archive/v_04.tar.gz',    # I explain this later on
